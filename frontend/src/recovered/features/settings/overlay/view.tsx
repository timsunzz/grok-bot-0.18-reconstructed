...
export type SettingsSectionId = "general" | "router" | "bots" | "usage" | "beta";

export interface SettingsSection {
  id: SettingsSectionId;
  label: string;
  icon: "settings-gear" | "git-branch" | "agents" | "chart-bars" | "cloud-download";
}

/** Reconstructs the shipped registry and the Router/Bots extensions. */
export const SETTINGS_SECTIONS: readonly SettingsSection[] = [
  { id: "general", label: "General", icon: "settings-gear" },
  { id: "router", label: "Router", icon: "git-branch" },
  { id: "bots", label: "Bots", icon: "agents" },
